...
namespace E4C
{
    static class Program
    {
        ...
        private static Container Bootstrap()
        {
            ...
            container.Register<ICheckDateTimeHandler, CheckDateTimeHandler>(Lifestyle.Singleton);
            container.Register<ICheckDateTimeValidator, CheckDateTimeValidator>(Lifestyle.Singleton);
            ...
            container.Register<IDateTimeCalc, DateTimeCalc>(Lifestyle.Singleton);
            container.Register<IDateTimeFactory, DateTimeFactory>(Lifestyle.Singleton);
            container.Register<IDateTimeHandler, DateTimeHandler>(Lifestyle.Singleton);
            ...
            container.Register<IHorizontalCalc, HorizontalCalc>(Lifestyle.Singleton);
            container.Register<IHorizontalHandler, HorizontalHandler>(Lifestyle.Singleton);
            container.Register<IHousesApi, HousesApi>(Lifestyle.Singleton);
            container.Register<IHousesCalc, HousesCalc>(Lifestyle.Singleton);
            container.Register<IHousesFacade, HousesFacade>(Lifestyle.Singleton);
            container.Register<IHousesHandler, HousesHandler>(Lifestyle.Singleton);
            ...
            container.Register<IJulDayCalc, JulDayCalc>(Lifestyle.Singleton);
            container.Register<IJulDayFacade, JulDayFacade>(Lifestyle.Singleton);
            container.Register<IJulDayHandler, JulDayHandler>(Lifestyle.Singleton);
