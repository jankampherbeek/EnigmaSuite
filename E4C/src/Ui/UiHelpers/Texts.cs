...
namespace E4C.Ui.UiHelpers
{
    ...
    public class TextAssembler : ITextAssembler
    {
        ...
        public string CreateTimeFullText(int[] timeValues, TimeZones timeZone, bool dst, int[]? lmtLongValues = null, Directions4GeoLong? dirGeoLong = null)
        {
            ...
            if (timeZone == TimeZones.LMT && lmtLongValues != null)
            {
                ...
                string _dirTextId = dirGeoLong == Directions4GeoLong.East ? "common.location.dirgeolong.east" : "common.location.dirgeolong.west";
