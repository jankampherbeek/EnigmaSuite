...
/// <summary>Details for a Rodden Rating.</summary>
...
{
    /// <summary>Returns the details for a Rodden rating.</summary>
    ...
    /// <summary>Returns a value from the enum RoddenRatings that corresponds with an index.</summary>
