...
public interface ITimeZoneSpecifications
{
    ...
    /// <returns>A record TimeZoneDetails with the details for a timne zone.</returns>
...
public class TimeZoneSpecifications : ITimeZoneSpecifications
{
    ...
    /// <inheritdoc/>
    /// <exception cref="ArgumentException">Is thrown if the index for the Time Zone was not recognized.</exception>
    public TimeZones TimeZoneForIndex(int timeZoneIndex)
    {
