...
/// <inheritdoc/>
public class DateTimeApiObs : IDateTimeApi
{
    private readonly IJulDayHandler _julDayHandler;
    private readonly IDateTimeHandler _dateTimeHandler;
    private readonly ICheckDateTimeHandler _checkDateTimeHandler;

    public DateTimeApiObs(IJulDayHandler julDayHandler, IDateTimeHandler dateTimeHandler, ICheckDateTimeHandler checkDateTimeHandler)
    {
