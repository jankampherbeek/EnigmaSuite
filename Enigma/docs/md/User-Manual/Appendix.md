...
Because the orbit of the Moon is highly irregular, corrections have been introduced to calculate the *Corrected Black Moon*. The most popular approach is from Max Duval, who unfortunately did not explain his approach nor give any formula. We only have his printed ephemeris. The Dutch astrologer Cees Jansen succeeded in the construction of a formula that mimics the values of Duval very closely, mostly within a minute of arc, but always within 3 minutes of arc.
