...
public class TestSpeculumItemPlacidus
{
    ...
    private const double RaPlanet = 100.0;
    private const double RaPlanetWest = 310.0;
    private const double DeclPlanet = 15.0;
    private const double DeclPlanetWest = -10.0;
    private const double RaMc = 70.0;
    private const double RaIc = 250.0;
    private const double OaAsc = 160.0;
    private const double OdDesc = 340.0;
    ...
    public void SetUp()
    {
        _speculumItem = new SpeculumItemPlacidus(GeoLat, RaMc, RaIc, OaAsc, OdDesc, RaPlanet, DeclPlanet);
        _speculumItemWest = new SpeculumItemPlacidus(GeoLat, RaMc, RaIc, OaAsc, OdDesc, RaPlanetWest, DeclPlanetWest);
    }
