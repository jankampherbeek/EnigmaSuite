...
public class TestHousesApi
{
    ...
    {
        var posCusp5 = CreateFullPointPos(100.0, 101.1, 2.2, 99.9, 3.3);
        var posCusp6 = CreateFullPointPos(130.0, 131.1, 2.3, 119.9, 2.2);
        var posMc = CreateFullPointPos(290.0, 292.1, 2.3, 310.9, 1.2);
        var posAscendant = CreateFullPointPos(20.0, 22.2, -1.1, 40.9, -3.5);
        var posVertex = CreateFullPointPos(205.0, 202.2, -1.14, 220.9, -5.5);
        var posEastPoint = CreateFullPointPos(25.0, 27.2, -1.1, 45.9, -0.5);
