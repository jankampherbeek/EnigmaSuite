...
namespace Enigma.Frontend.Ui.Models
{
    ...
    public sealed class SolarResultsModel
    {
        ...
        private readonly IProgPositionsForPresentationFactory _progPositionsForPresentationFactory;
        private readonly IDescriptiveChartText _descriptiveChartText;
        private readonly ICalculationPreferencesCreator _prefsCreator;

        private Dictionary<ChartPoints, FullPointPos>? _solarChart;
        private int _solarAge;
        private Location? _solarLocation;

        public SolarResultsModel(SolarService solarService,
            ...
            ICalculationPreferencesCreator prefsCreator)
        {
            ...
            _progPositionsForPresentationFactory = progPositionsForPresentationFactory;
            _descriptiveChartText = descriptiveChartText;
            _prefsCreator = prefsCreator;
        }
        ...
        public List<PresentableProgPosition> GetSolarPositions()
        {
            ...
            return _progPositionsForPresentationFactory.CreatePresProgPos(_solarChart);
        }
