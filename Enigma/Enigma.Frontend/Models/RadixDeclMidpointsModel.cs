...
public class RadixDeclMidpointsModel(
    IDeclMidpointsApi declMidpointsApi,
    ...
    IDescriptiveChartText descriptiveChartText)
{
    ...
    public IEnumerable<PresentableOccupiedMidpoint> GetPresentableDeclMidpoints()
    {
        ...
        IEnumerable<OccupiedMidpoint> occupiedMidpoints = declMidpointsApi.OccupiedDeclMidpoints(chart, orb);
        IEnumerable<PresentableOccupiedMidpoint> presOccMidpoints = midpointForDataGridFactory.CreateMidpointsDataGrid(occupiedMidpoints);
