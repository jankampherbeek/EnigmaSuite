...
public class RadixParallelsModel(
    IParallelsForDataGridFactory parallelForDataGridFactory,
    IParallelsApi parallelsApi,
    IDescriptiveChartText descriptiveChartText)
{
    ...
    {
        var effParallels = parallelsApi.ParallelsForCelPoints(CreateRequest());
        return parallelForDataGridFactory.CreateParallelsForDataGrid(effParallels);
    }
