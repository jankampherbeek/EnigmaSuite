...
{
    public bool HandleTime(string inputTime, double offset, bool dst, out FullTime? fullTime);
}
...
public class TimeInputParser : ITimeInputParser
{
    ...
    public bool HandleTime(string inputTime, double offset, bool dst, out FullTime? fullTime)
    {
        ...
        bool validationSuccess = timeSuccess && _timeValidator.CreateCheckedTime(timeValues, offset, dst, out fullTime);
