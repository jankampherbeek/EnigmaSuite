...
namespace Enigma.Frontend
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            MessageBox.Show("Settings not yet implemented.");
        }

        private void GeneralConfigurationClick(object sender, RoutedEventArgs e)
        {
            MessageBox.Show("Configuration not yet implemented.");
        }
        ...
        {
            MessageBox.Show("Data import not yet implemented.");
        }
