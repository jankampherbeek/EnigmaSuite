...
public sealed class PersistableChartData
{
    ...
    public PersistableChartData(string name, string description, string source, ChartCategories chartCategory, RoddenRatings rating, double julianDayEt, string dateText, string timeText, string locationName, double geoLong, double geoLat)
    {
        Name = name;
