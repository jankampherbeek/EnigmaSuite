...
public record ObliqueLongitudeRequest
{
    ...
    public readonly List<NamedEclipticCoordinates> CelPointCoordinates;
    ...
    public ObliqueLongitudeRequest(double armc, double obliquity, double geoLat, List<NamedEclipticCoordinates> celPointCoordinates)
    {
        Armc = armc;
        Obliquity = obliquity;
        GeoLat = geoLat;
