...
public static class PointsExtensions
{
    ...
    public static PointDetails GetDetails(this ChartPoints point)
    {
        return point switch
        {
            ...
            ChartPoints.BlackSun => new PointDetails(point, PointCats.Common, CalculationCats.CommonFormula, "Black Sun (aphelion)"),
            ChartPoints.Diamond => new PointDetails(point, PointCats.Common, CalculationCats.CommonFormula, "Diamond (perihelion)"),
