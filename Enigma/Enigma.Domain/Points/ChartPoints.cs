...
public static class PointsExtensions
{
    ...
    public static PointDetails GetDetails(this ChartPoints point)
    {
        return point switch
        {
            ...
            ChartPoints.MeanNode => new PointDetails(point, PointCats.Common, CalculationCats.CommonSe, "Mean node"),
            ChartPoints.TrueNode => new PointDetails(point, PointCats.Common, CalculationCats.CommonSe, "True node"),
