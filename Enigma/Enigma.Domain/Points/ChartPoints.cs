...
public static class PointsExtensions
{
    ...
    public static PointDetails GetDetails(this ChartPoints point)
    {
        return point switch
        {
            ...
            ChartPoints.Ascendant => new PointDetails(point, PointCats.Angle, CalculationCats.Specific, "ref.enum.mundanepoint.id.asc"),
            ChartPoints.Mc => new PointDetails(point, PointCats.Angle, CalculationCats.Specific, "ref.enum.mundanepoint.id.mc"),
            ChartPoints.EastPoint => new PointDetails(point, PointCats.Angle, CalculationCats.Specific, "ref.enum.mundanepoint.id.eastpoint"),
            ChartPoints.Vertex => new PointDetails(point, PointCats.Angle, CalculationCats.Specific, "ref.enum.mundanepoint.id.vertex"),

            ChartPoints.Cusp1 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.1"),
            ChartPoints.Cusp2 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.2"),
            ChartPoints.Cusp3 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.3"),
            ChartPoints.Cusp4 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.4"),
            ChartPoints.Cusp5 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.5"),
            ChartPoints.Cusp6 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.6"),
            ChartPoints.Cusp7 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.7"),
            ChartPoints.Cusp8 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.8"),
            ChartPoints.Cusp9 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.9"),
            ChartPoints.Cusp10 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.10"),
            ChartPoints.Cusp11 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.11"),
            ChartPoints.Cusp12 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.12"),
            ChartPoints.Cusp13 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.13"),
            ChartPoints.Cusp14 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.14"),
            ChartPoints.Cusp15 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.15"),
            ChartPoints.Cusp16 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.16"),
            ChartPoints.Cusp17 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.17"),
            ChartPoints.Cusp18 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.18"),
            ChartPoints.Cusp19 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.19"),
            ChartPoints.Cusp20 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.20"),
            ChartPoints.Cusp21 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.21"),
            ChartPoints.Cusp22 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.22"),
            ChartPoints.Cusp23 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.23"),
            ChartPoints.Cusp24 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.24"),
            ChartPoints.Cusp25 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.25"),
            ChartPoints.Cusp26 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.26"),
            ChartPoints.Cusp27 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.27"),
            ChartPoints.Cusp28 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.28"),
            ChartPoints.Cusp29 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.29"),
            ChartPoints.Cusp30 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.30"),
            ChartPoints.Cusp31 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.31"),
            ChartPoints.Cusp32 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.32"),
            ChartPoints.Cusp33 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.33"),
            ChartPoints.Cusp34 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.34"),
            ChartPoints.Cusp35 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.35"),
            ChartPoints.Cusp36 => new PointDetails(point, PointCats.Cusp, CalculationCats.Specific, "ref.enum.cusps.36"),

            ChartPoints.ZeroAries => new PointDetails(point, PointCats.Zodiac, CalculationCats.Specific, "ref.enum.zodiacpoints.id.zeroar"),
            ChartPoints.ZeroCancer => new PointDetails(point, PointCats.Zodiac, CalculationCats.Specific, "ref.enum.zodiacpoints.id.zerocn"),

            ChartPoints.FortunaSect => new PointDetails(point, PointCats.Arabic, CalculationCats.Specific, "ref.enum.arabicpoint.fortunasect"),
            ChartPoints.FortunaNoSect => new PointDetails(point, PointCats.Arabic, CalculationCats.Specific, "ref.enum.arabicpoint.fortunanosect"),
